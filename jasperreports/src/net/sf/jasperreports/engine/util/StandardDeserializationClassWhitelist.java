...
/**
 * Standard implementation of {@link DeserializationClassWhitelist} that supports
 * exact class name matching and wildcard patterns.
 */
public class StandardDeserializationClassWhitelist implements DeserializationClassWhitelist
{
	...
	public StandardDeserializationClassWhitelist()
	{
